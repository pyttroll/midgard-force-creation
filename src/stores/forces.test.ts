...
describe('Forces Store', () => {
  ...
  it('should add custom hero trait', () => {
    ...
    const store = useForcesStore()
    const trait = new HeroTrait('Test Trait', 'Test description', false, 10, undefined, true)
  ...
  it('should add custom unit trait', () => {
    ...
    const store = useForcesStore()
    const trait = new UnitTrait('Test Unit Trait', 'Test description', [5], false, undefined, true)
